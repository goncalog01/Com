...
namespace l22 {
  ...
  public:
    xml_writer(std::shared_ptr<cdk::compiler> compiler, cdk::symbol_table<l22::symbol> &symtab, std::stack<std::shared_ptr<cdk::functional_type>> &funcs) :
        basic_ast_visitor(compiler), _symtab(symtab), _funcs(funcs), _inFunctionArgs(false), _inFunctionBody(0) {
    }
